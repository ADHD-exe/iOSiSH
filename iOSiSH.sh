...
HOME_PC_SSH_KEY_PATH="${HOME_PC_SSH_KEY_PATH:-$PRIMARY_HOME/.ssh/id_ed25519}"
...
populate_defaults() {
    ...
    if [ -z "${HOME_PC_SSH_KEY_PATH:-}" ] || [ "$HOME_PC_SSH_KEY_PATH" = ".ssh/id_ed25519" ]; then
        HOME_PC_SSH_KEY_PATH="$PRIMARY_HOME/.ssh/id_ed25519"
    fi
}
...
write_shared_aliases() {
    alias_file="$PRIMARY_HOME/.config/zsh/.aliases"
